...
/* ── Build a round from a word entry ── */
function buildRound(entry, distractorCount) {
              ...
              if (isBlank) {
                return (
                  <div
                    ...
                    onDrop={onDrop}
                    className={`w-14 h-16 sm:w-16 sm:h-20 rounded-xl border-2 border-dashed flex items-center justify-center text-3xl sm:text-4xl font-black transition-all duration-200 ${
                      filled
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-2">
          {round.tiles.map((letter, i) => (
            <motion.div
              ...
              className={`w-14 h-14 sm:w-16 sm:h-16 rounded-xl flex items-center justify-center text-2xl sm:text-3xl font-black select-none transition-colors duration-200 ${
                feedback

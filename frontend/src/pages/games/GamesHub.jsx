...
export default function GamesHub() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-white">
      ...
      <div className="w-full max-w-6xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 md:py-10">
        {/* Header */}
        <div className="mb-8 md:mb-10 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          <div>
            ...
            <motion.p
              ...
              className="mt-2 text-sm sm:text-base text-gray-400 max-w-lg"
            >
          ...
          {GAMES.map((game) => (
            <motion.div key={game.id} variants={card}>
              <Link to={game.path} className="block group h-full">
                ...
                >
                  {/* Tag */}
                  <span className="absolute top-3 right-3 px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-white/10 text-gray-300 border border-white/20">
                    {game.tag}
                  </span>
